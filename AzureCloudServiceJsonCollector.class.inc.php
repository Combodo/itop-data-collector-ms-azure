...
class AzureCloudServiceJsonCollector extends AzureJsonCollector {
	/**
	 * @inheritdoc
	 */
	protected function GetUrl($iSubscription, $sResourceGroupName): string {
		return $this->sResource.'/subscriptions/'.$iSubscription.'/providers/Microsoft.Compute/cloudServices?api-version='.$this->sApiVersion;
	}
