...
class AzureCosmosDBAccountJsonCollector extends AzureJsonCollector {
	/**
	 * @inheritdoc
	 */
	protected function GetUrl($iSubscription, $sResourceGroupName): string {
		return $this->sResource.'/subscriptions/'.$iSubscription.'/providers/Microsoft.DocumentDB/databaseAccounts?api-version='.$this->sApiVersion;
	}
