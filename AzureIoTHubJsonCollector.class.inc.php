...
class AzureIoTHubJsonCollector extends AzureJsonCollector {
	/**
	 * @inheritdoc
	 */
	...
	protected function GetUrl($iSubscription, $sResourceGroupName): string {
		return $this->sResource.'/subscriptions/'.$iSubscription.'/resourceGroups/'.$sResourceGroupName.'/providers/Microsoft.Devices/IotHubs?api-version='.$this->sApiVersion;
	}
