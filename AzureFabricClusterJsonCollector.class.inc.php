...
class AzureFabricClusterJsonCollector extends AzureJsonCollector {
	/**
	 * @inheritdoc
	 */
	protected function GetUrl($iSubscription, $sResourceGroupName): string {
		return $this->sResource.'/subscriptions/'.$iSubscription.'/providers/Microsoft.ServiceFabric/clusters?api-version='.$this->sApiVersion;
	}
