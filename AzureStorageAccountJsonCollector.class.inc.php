...
class AzureStorageAccountJsonCollector extends AzureJsonCollector {
	/**
	 * @inheritdoc
	 */
	...
	protected function GetUrl($iSubscription, $sResourceGroupName): string {
		return $this->sResource.'/subscriptions/'.$iSubscription.'/resourceGroups/'.$sResourceGroupName.'/providers/Microsoft.Storage/storageAccounts?api-version='.$this->sApiVersion;
	}
